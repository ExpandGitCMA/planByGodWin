...
@interface DFCGoodStoreView ()<UICollectionViewDataSource,UICollectionViewDelegate>
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    GoodPreViewViewController*controller = [[GoodPreViewViewController alloc] initWithNibName:@"GoodPreViewViewController" bundle:nil];
