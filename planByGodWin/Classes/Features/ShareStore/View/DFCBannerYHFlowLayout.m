...
static CGFloat lineSpace = 40.0;
static CGFloat zoomScale = 1.45;
static CGFloat minZoomScale = 0.45;

@implementation DFCBannerYHFlowLayout
{
    NSInteger _index;
}
...
- (NSArray<UICollectionViewLayoutAttributes *> *)layoutAttributesForElementsInRect:(CGRect)rect {
    ...
    for (UICollectionViewLayoutAttributes *attributes in visibleItemArray) {
        ...
        //5. 缩放
        CATransform3D scaleTransform = CATransform3DMakeScale(1 + scale * minZoomScale, 1 + scale * minZoomScale , 1);
//        attributes.transform3D = CATransform3DMakeScale(1 + scale * minZoomScale, 1 + scale * minZoomScale , 1);
//        CATransform3D rotateTransform;
        // 6.旋转(左侧 逆时针 ，右侧 顺时针)
        
//        DEBUG_NSLog(@"比率-%.2f",scale *minZoomScale);
//        if (halfCenterX - leftMargin <self.collectionView.bounds.size.width / 4) { // 左侧
//            rotateTransform = CATransform3DMakeRotation(M_PI_2  *scale *minZoomScale, 0, 1, 0);
//            
//        }else if (leftMargin - halfCenterX >self.collectionView.bounds.size.width / 4){ // 右侧
//            rotateTransform = CATransform3DMakeRotation(-M_PI_2  *scale *minZoomScale, 0, 1, 0);
//        }else {
//            rotateTransform = CATransform3DIdentity;
//        }
//        rotateTransform.m34 = -1/100.0;
        
//        CATransform3D concatTransform = CATransform3DConcat(scaleTransform, rotateTransform);
