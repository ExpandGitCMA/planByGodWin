...
@interface DFCSeminary ()<UIPickerViewDataSource,UIPickerViewDelegate>
...
-(UIPickerView*)pickerView{
    if (!_pickerView) {
        _pickerView=[[UIPickerView alloc]initWithFrame:CGRectMake(15, 0, sizeWidth/2-60, sizeHeight)];
...
-(UIPickerView*)classInfoPicker{
    if (!_classInfoPicker) {
        _classInfoPicker=[[UIPickerView alloc]initWithFrame:CGRectMake(( sizeWidth/2-20), 0,  sizeWidth/2-60, sizeHeight)];
