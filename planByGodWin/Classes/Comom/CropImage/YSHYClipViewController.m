...
-(void)CreatUI
{
    ...
    [clipBtn setTitle:@"确定" forState:UIControlStateNormal];
    [clipBtn addTarget:self action:@selector(clipBtnSelected:) forControlEvents:UIControlEventTouchUpInside];
//    [clipBtn setBackgroundColor:kUIColorFromRGB(ButtonGreenColor)];
    [clipBtn setBackgroundColor:[UIColor blackColor]];
