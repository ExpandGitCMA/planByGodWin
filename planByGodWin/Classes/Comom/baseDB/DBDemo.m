...
+ (void)demo {
    ...
    // 条件查找
    NSArray *allUser1 = [UserModel findByConditionStatement:@"WHERE primarykey > 50"];
    DEBUG_NSLog(@"allUser1 = %@", allUser1);
    
    // format 条件查找
    NSArray *allUser2 = [UserModel findByFormat:@"WHERE primarykey > %@", @"50"];
    DEBUG_NSLog(@"allUser2 = %@", allUser2);
}
